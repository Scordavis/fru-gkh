	...
	<header class="container-fluid site-header">
		<div class="container h-100">
			<div class="row h-100 align-items-center">
				...
				<button class="col mx-2 py-3 button button--white site-header__button">Кнопка 2</button>
				<button class="col mx-2 py-3 button button--white site-header__button"><i class="fa fa-sliders" style="color: red; width: 1px; position: relative; right: 22px;"></i>Фільтри</button>
			</div>
		</div>
	</header>
...
<div class="container" style="position: relative; background-color: white; z-index: 10; display: none;">
	<!-- form -->
	<form action="" class="row z-index-3 mb-4 py-4  emergency-service__form-wrapper">
		<!-- street -->
		...
		<!-- submit -->
		<div class="col-lg-3 col-md-4 col-sm-5 col-10 offset-1 offset-sm-0 mt-0 mt-lg-2 emergency-service__form-input">
			<button type="submit" class="w-100 py-3 emergency-service__form-btn emergency-service__form-btn--red">Готово<i class="pl-2 fa fa-angle-double-right"></i></button>
		</div>
	</form>
</div>
