...
<section class="bng_section consultant" style="padding-bottom:0px;">
		<div class="cont">
			<div class="">
			   <span class="name" >
...
<section class="bng_section d-flex justify-content-between align-items-center" style="padding-top:10px;padding-bottom:10px;">
    <div class="cont">
