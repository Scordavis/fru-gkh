...
<a data-fancybox href="#modalWindow<?=$d['id']?>"><?=$d['nazva_dilnyci']?><!-- scor added data-fancybox  --></a>
...
<?if ( $d['tip_dilnyci']!=='Будинок' ) {?>
			...
			<!-- <a href="#modal" class="overlay"></a> --><!-- scor comment overlay -->
			<!-- scor remove class="popup_introduce" and added class="fancy-wrapper" from div above -->

					<div class="fancy-wrapper px-10" id="modalWindow<?=$d['id']?>" style="display: none;"> <!-- scor change style="box-shadow: 20px 30px 40px rgba(0,0,0,0.9);" -->
						<?
