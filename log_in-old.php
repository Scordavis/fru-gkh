...
<body>
	...
	<div class="container py-5 login-page">
		<div class="row">
			...
			<!-- left side -->
			<div class="col-7 py-4 login-page__li-wrapper">
					...
					<div class="col-8 offset-2">
						<div class="row justify-content-around">
							...
							<div class="col text-center">
								<img src="/tpl/images/cold.png" alt="" class="login-page__ico">
							</div>
							<!-- ico -->
							<div class="col text-center">
								<img src="/tpl/images/energy.png" alt="" class="login-page__ico">
							</div>
							<!-- ico -->
							<div class="col text-center">
								<img src="/tpl/images/gas.png" alt="" class="login-page__ico">
							</div>
							<!-- ico -->
							<div class="col text-center">
								<img src="/tpl/images/hot.png" alt="" class="login-page__ico">
							</div>
						</div>
					</div>
				</div>
