...
<section class="bng_section" style="margin-top:-5px;padding-bottom:10px;padding-top:20px;">
	<div class="cont cont--small d-flex justify-content-between" >
		<div class=" ">
			<form id="boss_calendar" method="post" action="/grafiks/boss_calendar/?id=<?=$id?>">
<!--</div> style="float: right;margin-left:15%;width:50%;height:30%;
  ...
  <div id="rrr">
  	<br/>
  	<span class="consnamered" >Фактично відпрацьований час: </span><!--input type="submit"   value="Готово" /-->
  	<br/>
  	<span class="consname" >Кількість робочих днів у поточному місяці:</span>
  	<span  id="CountDateDir" class="consinfo"><?=$CountDateDir?>;</span>
  </div>
...
<section class="section_edit ">
	<div class="bng_red">
		<div class="cont cont--small">
			<div class="box_flex box_flex--small justify-content-end pr-10">
				<div class="name"></div>
				<div class="edit">
					<a href="" class="hiderKontrakt submit_btn" >Редагувати</a>
				</div>
